...
export default function CommercialVolumeTab({ ws }: Props) {
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="py-2 px-4 bg-muted/20 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold">Commercial Volume Readiness</span>
          </div>
        </CardHeader>
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="py-2 px-4 bg-muted/20 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold">Commercial / Shared Blocks</span>
            <Badge variant="outline" className="text-[8px]">{commBlocks.length} block{commBlocks.length !== 1 ? "s" : ""}</Badge>
          </div>
        </CardHeader>
        <CardContent className="p-0">
          {commBlocks.length === 0 ? (
            <p className="text-sm text-muted-foreground text-center py-8">No Commercial or Shared blocks in proposal block register.</p>
          ) : (
