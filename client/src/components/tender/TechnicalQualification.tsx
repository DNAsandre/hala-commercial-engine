...
export default function TechnicalQualification({ ws }: Props) {
  const t = ws.tender;
  const tenderId = t.id;
    ...
    <div className="space-y-4">
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="pb-2 border-b border-border bg-muted/20">
          <SectionToggle title="Technical Fit Summary" icon={<BarChart3 className="w-3.5 h-3.5 text-indigo-600" />} open={openSections.summary} onToggle={() => toggle("summary")}
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="pb-2 border-b border-border bg-muted/20">
          <SectionToggle title="Technical Capability Assessment" icon={<ShieldCheck className="w-3.5 h-3.5 text-indigo-600" />} open={openSections.capability} onToggle={() => toggle("capability")}
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="pb-2 border-b border-border bg-muted/20">
          <SectionToggle title="Technical Clarifications" icon={<MessageSquare className="w-3.5 h-3.5 text-indigo-600" />} open={openSections.clarifications} onToggle={() => toggle("clarifications")}
      ...
      <Card className="border-border shadow-none">
        <CardHeader className="pb-2 border-b border-border bg-muted/20">
          <SectionToggle title="Technical Recommendation" icon={<ShieldCheck className="w-3.5 h-3.5 text-indigo-600" />} open={openSections.recommendation} onToggle={() => toggle("recommendation")} />
        </CardHeader>
      ...
      <div className="flex items-center gap-3 pt-1">
        <Button
          size="sm"
          className="gap-1.5 h-9 text-xs px-5"
          onClick={handleSave}
