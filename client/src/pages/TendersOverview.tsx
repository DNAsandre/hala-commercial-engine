 ...
 * No mock data. No proposal heuristics.
...
const TENDER_STAGES: { key: TenderStageKey; label: string; tone: string; labelColor: string; border: string }[] = [
  ...
  { key: "solution_design", label: "Solution Design", tone: "bg-indigo-50", labelColor: "text-indigo-600", border: "border-l-indigo-400" },
  { key: "pnl_pricing", label: "P&L / Pricing", tone: "bg-violet-50", labelColor: "text-violet-600", border: "border-l-violet-400" },
  { key: "tender_drafting", label: "Tender Drafting", tone: "bg-purple-50", labelColor: "text-purple-600", border: "border-l-purple-400" },
  ...
  { key: "technical_review", label: "Technical Review", tone: "bg-sky-50", labelColor: "text-sky-700", border: "border-l-sky-400" },
  { key: "commercial_review", label: "Commercial Review", tone: "bg-rose-50", labelColor: "text-rose-700", border: "border-l-rose-400" },
    ...
    <Card onClick={onClick} className="border shadow-none hover:shadow-md hover:border-primary/40 transition-all cursor-pointer group">
      <CardContent className="p-3.5 space-y-2">
        ...
        <div className="flex items-center gap-1.5 pt-1.5 border-t border-border/40">
          ...
          <span className="text-[9px] text-indigo-600 truncate flex-1">Open tender workspace</span>
    ...
    <Dialog open={open} onOpenChange={value => { if (!value) onClose(); }}>
      <DialogContent className="max-w-3xl p-0 gap-0 overflow-hidden">
        ...
        <div className="px-8 py-4 flex items-center justify-between">
          ...
          <Button
            size="sm"
            onClick={() => { onClose(); navigate(`/tenders/${tender.id}`); }}
          >
