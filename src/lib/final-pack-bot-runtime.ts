...
export async function runBlockAIMicrobot(params: {
  ...
  // SC-01 Wave 02 boundary (deferred to Sprint X - SX-001/SX-011): AI execution is excluded
  // from this build. Per this module contract the editor is never blocked -
  // the refusal is returned as an honest error preview, with no audit write
  ...
  return {
    ...
    error: "AI assistance is not available in this build (deferred to Sprint X - SX-001/SX-011).",
  };
}
