 ...
 *   - Generate AI content
 *   - Write to Supabase
 *   - Modify discontinued document tooling / doc_instances / doc_instance_versions
...
export const PROPOSAL_BLOCK_MAPPINGS: ProposalBlockMapping[] = [
  ...
  // 9. Tender Drafting → Full Proposal Assembly
  {
    ...
    futureUse: ["Technical Proposal Draft", "Commercial Proposal Draft", "Final Document Assembly"],
 ...
 * - Never modifies discontinued document tooling.
