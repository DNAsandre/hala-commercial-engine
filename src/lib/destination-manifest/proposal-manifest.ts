...
const COMMERCIAL_APPROVAL: FieldDescriptor[] = [
  ...
  ...group(
    ...
    [
      { key: "linkedPnlVersion", type: "id_ref", label: "Linked P&L version" },
      { key: "finalRevenue", notes: "Commercial position is stored as descriptive text by the owning UI." },
      { key: "finalCost", notes: "INTERNAL. Commercial position is stored as descriptive text by the owning UI." },
      { key: "finalGrossProfit", notes: "INTERNAL. Commercial position is stored as descriptive text by the owning UI." },
      { key: "finalGpPercent", label: "Final GP %", notes: "INTERNAL. Margin position is stored as descriptive text by the owning UI." },
...
const CONTRACT_SIGNED: FieldDescriptor[] = [
  ...
  ...group(
    ...
    [
      ...
      { key: "finalRevenue", notes: "Signed commercial position is stored as descriptive text by the owning UI." },
      { key: "finalCost", notes: "INTERNAL. Signed commercial position is stored as descriptive text by the owning UI." },
      { key: "finalGrossProfit", notes: "INTERNAL. Signed commercial position is stored as descriptive text by the owning UI." },
      { key: "finalGpPercent", label: "Final GP %", notes: "INTERNAL. Signed margin position is stored as descriptive text by the owning UI." },
      { key: "pricingNotes" },
    ],
  ),
  ...group(
