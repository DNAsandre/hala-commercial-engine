-- =========================================================
-- LEGACY TENDER SLOP REMOVAL - DRY RUN FIRST
-- Date: 2026-05-21
--
-- Purpose:
...
-- ---------------------------------------------------------
-- 5. Dry-run verification. Because this script rolls back,
--    these counts show what would remain inside the transaction.
-- ---------------------------------------------------------
...
SELECT 'DRY RUN COMPLETE - ROLLBACK WILL PRESERVE LIVE DATA - PASTE RESULTS BACK TO CODEX' AS next_step;
