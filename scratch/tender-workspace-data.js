"use strict";
/**
 * Tender Workspace Data — Mock data for TND-001 / TND-002
 *
 * Provides tender workspace structures, packs, pack sections,
 * readiness breakdowns, mock gates, activity events, and audit entries.
 *
 * No database. No API. Pure frontend mock layer.
 */
...
exports.lindeTender = exports.COMPLIANCE_RISK_LEVELS = exports.COMPLIANCE_CATEGORIES = exports.REQUIRED_DOC_CATEGORIES = exports.PLACEHOLDER_CATEGORIES = exports.SEVERITY_OPTIONS = exports.AUDIT_CATEGORIES = exports.ACTIVITY_CATEGORIES = exports.GATE_SEVERITIES = exports.GATE_CATEGORIES = void 0;
exports.getGateSeverityColor = getGateSeverityColor;
exports.getGateCategoryLabel = getGateCategoryLabel;
exports.getGateEnforcementLabel = getGateEnforcementLabel;
exports.getGateRuntimeLabel = getGateRuntimeLabel;
exports.getGateStatusColor = getGateStatusColor;
exports.getSeverityColor = getSeverityColor;
exports.getActivityCategoryLabel = getActivityCategoryLabel;
exports.getAuditCategoryLabel = getAuditCategoryLabel;
exports.getPlaceholderStatusLabel = getPlaceholderStatusLabel;
exports.getPlaceholderStatusColor = getPlaceholderStatusColor;
exports.getCategoryLabel = getCategoryLabel;
exports.getEvidenceStatusLabel = getEvidenceStatusLabel;
exports.getDocStatusLabel = getDocStatusLabel;
exports.getDocStatusColor = getDocStatusColor;
exports.getDocCategoryLabel = getDocCategoryLabel;
exports.getFileReqLabel = getFileReqLabel;
exports.getFileReqColor = getFileReqColor;
exports.getComplianceStatusLabel = getComplianceStatusLabel;
exports.getComplianceStatusColor = getComplianceStatusColor;
exports.getComplianceCategoryLabel = getComplianceCategoryLabel;
exports.getRiskLabel = getRiskLabel;
exports.getRiskColor = getRiskColor;
exports.getSplitCheckStatusLabel = getSplitCheckStatusLabel;
exports.getSplitCheckStatusColor = getSplitCheckStatusColor;
exports.getSplitCheckCategoryLabel = getSplitCheckCategoryLabel;
exports.getPackOutputStatusLabel = getPackOutputStatusLabel;
exports.getPackOutputStatusColor = getPackOutputStatusColor;
exports.getEmailStatusLabel = getEmailStatusLabel;
exports.getEmailStatusColor = getEmailStatusColor;
exports.getEmailTypeLabel = getEmailTypeLabel;
exports.getAttachmentStatusLabel = getAttachmentStatusLabel;
exports.getAttachmentStatusColor = getAttachmentStatusColor;
exports.getTenderRiskSummary = getTenderRiskSummary;
exports.getTenderExecutionSignals = getTenderExecutionSignals;
exports.getAllTenderExecutionSignals = getAllTenderExecutionSignals;
exports.getTenderWorkspaceById = getTenderWorkspaceById;
exports.getLindeTenderId = getLindeTenderId;
exports.getPackStatusLabel = getPackStatusLabel;
exports.getPackTypeLabel = getPackTypeLabel;
exports.getGateStatusLabel = getGateStatusLabel;
exports.getSectionStatusLabel = getSectionStatusLabel;
exports.getSectionStatusColor = getSectionStatusColor;
exports.getSectionApprovalLabel = getSectionApprovalLabel;
var tender_engine_1 = require("./tender-engine");
exports.GATE_CATEGORIES = [
...
function getActivityCategoryLabel(c) {
    ...
    if (!c)
        return "General";
    return ((_a = exports.ACTIVITY_CATEGORIES.find(function (x) { return x.value === c; })) === null || _a === void 0 ? void 0 : _a.label) || c;
}
function getAuditCategoryLabel(c) {
    var _a;
    if (!c)
        return "General";
    return ((_a = exports.AUDIT_CATEGORIES.find(function (x) { return x.value === c; })) === null || _a === void 0 ? void 0 : _a.label) || c;
}
exports.PLACEHOLDER_CATEGORIES = [
    { value: "all", label: "All Categories" },
...
exports.REQUIRED_DOC_CATEGORIES = [
    { value: "all", label: "All Categories" },
...
exports.COMPLIANCE_RISK_LEVELS = [
...
var lindeWorkspace = {
    ...
    activityEvents: __spreadArray(__spreadArray([], lindeActivityEvents, true), [{ id: "act-006", tenderWorkspaceId: LINDE_TENDER_ID, eventType: "placeholders_scanned", title: "Placeholders Scanned", description: "Placeholder register scanned — 5 missing, 2 need evidence", category: "placeholder", userId: "u-amin", userName: "Amin Al-Halabi", role: "Tender Lead", timestamp: "2026-04-28T15:00:00Z", relatedModule: "Placeholders", severity: "warning", mock: true },
        ...
        { id: "act-018", tenderWorkspaceId: LINDE_TENDER_ID, eventType: "crm_sync_simulated", title: "CRM Sync Simulated", description: "CRM sync simulation complete — no external CRM was updated", category: "crm_sync_mock", userId: "u-amin", userName: "Amin Al-Halabi", role: "Tender Lead", timestamp: "2026-04-29T12:00:00Z", severity: "info", mock: true },], false),
    auditEntries: __spreadArray(__spreadArray([], lindeAuditEntries, true), [{ id: "aud-006", tenderWorkspaceId: LINDE_TENDER_ID, action: "PLACEHOLDERS_SCANNED", eventCode: "PLH-SCN", eventName: "Placeholder Register Scanned", entityType: "tender_workspace", entityId: LINDE_TENDER_ID, entityName: "Linde SIGAS Transportation Tender", category: "PLACEHOLDER", userId: "u-amin", userName: "Amin Al-Halabi", role: "Tender Lead", timestamp: "2026-04-28T15:00:00Z", details: "Placeholder register scanned. 18 total, 5 missing, 2 needs evidence. 12 would block production.", beforeState: "Not Scanned", afterState: "5 Missing", severity: "warning", mock: true, traceId: "trc-006" },
        ...
        { id: "aud-016", tenderWorkspaceId: LINDE_TENDER_ID, action: "PRODUCTION_BLOCK_SIMULATED", eventCode: "PRD-BLK", eventName: "Production Block Simulated", entityType: "tender_workspace", entityId: LINDE_TENDER_ID, entityName: "Linde SIGAS Transportation Tender", category: "SYSTEM", userId: "u-system", userName: "System", role: "System", timestamp: "2026-04-29T12:30:00Z", details: "Production block simulation: 10 gates, 12 placeholders, 14 documents would block production. No enforcement active.", beforeState: "—", afterState: "Simulated", severity: "high", mock: true, traceId: "trc-016" },], false),
};
var tenderWorkspaces = [lindeWorkspace];
function getTenderRiskSummary(tenderId) {
    var ws = tenderWorkspaces.find(function (w) { return w.tender.id === tenderId; });
    if (!ws)
        return null;
    var t = ws.tender;
    var missingPh = ws.placeholders.filter(function (p) { return p.status === "missing" || p.status === "needs_evidence"; }).length;
    var missingDocs = ws.requiredDocuments.filter(function (d) { return d.status === "awaiting" || d.nativeStatus === "missing" || d.signedPdfStatus === "missing"; }).length;
    var compGaps = ws.complianceItems.filter(function (c) { return c.status === "non_compliant" || c.status === "partial" || c.status === "clarification_required"; }).length;
    var gatesBlock = ws.mockGates.filter(function (g) { return g.wouldBlock; }).length;
    var critGates = ws.mockGates.filter(function (g) { return g.severity === "critical"; }).length;
    var daysLeft = Math.ceil((new Date(t.submissionDeadline).getTime() - Date.now()) / (1000 * 60 * 60 * 24));
    var risk = "green";
    if (gatesBlock > 5 || missingDocs > 5 || critGates > 0 || compGaps > 5)
        risk = "red";
    else if (gatesBlock > 0 || missingDocs > 0 || missingPh > 0 || compGaps > 0)
        risk = "amber";
    var nextAction = "Review tender workspace";
    if (critGates > 0)
        nextAction = "Review critical submission gates";
    else if (missingDocs > 5)
        nextAction = "Complete missing required documents";
    else if (compGaps > 3)
        nextAction = "Resolve compliance gaps";
    else if (missingPh > 3)
        nextAction = "Populate missing placeholders";
    else if (gatesBlock > 0)
        nextAction = "Review submission gates";
    var packLabel = ws.packs.length > 1
        ? ws.packs.map(function (p) { return p.packType === "internal_master" ? "Master" : p.packName.split(" ")[0]; }).join(" + ")
...
function getTenderExecutionSignals(tenderId) {
    var summary = getTenderRiskSummary(tenderId);
    if (!summary)
        return [];
    var signals = [];
    var base = { tenderId: summary.tenderId, tenderTitle: summary.tenderTitle, customerName: summary.customerName, deadline: summary.deadline, daysToDeadline: summary.daysToDeadline, developmentMode: true };
    if (summary.gatesWouldBlock > 0)
        signals.push(__assign(__assign({}, base), { riskColor: summary.gatesWouldBlock > 5 ? "red" : "amber", riskReason: "".concat(summary.gatesWouldBlock, " mock gates would block production"), nextAction: "Review Submission Gates", signalType: "gate" }));
    if (summary.missingDocuments > 0)
        signals.push(__assign(__assign({}, base), { riskColor: summary.missingDocuments > 5 ? "red" : "amber", riskReason: "".concat(summary.missingDocuments, " required documents incomplete"), nextAction: "Complete Required Documents", signalType: "document" }));
    if (summary.complianceGaps > 0)
        signals.push(__assign(__assign({}, base), { riskColor: summary.complianceGaps > 3 ? "red" : "amber", riskReason: "".concat(summary.complianceGaps, " compliance gaps (partial/non-compliant/clarification)"), nextAction: "Resolve Compliance Matrix", signalType: "compliance" }));
    if (summary.missingPlaceholders > 0)
        signals.push(__assign(__assign({}, base), { riskColor: summary.missingPlaceholders > 3 ? "red" : "amber", riskReason: "".concat(summary.missingPlaceholders, " placeholders missing or need evidence"), nextAction: "Populate Placeholders", signalType: "placeholder" }));
    if (summary.daysToDeadline <= 14 && summary.daysToDeadline > 0)
        signals.push(__assign(__assign({}, base), { riskColor: summary.daysToDeadline <= 7 ? "red" : "amber", riskReason: "".concat(summary.daysToDeadline, " days to submission deadline"), nextAction: "Prioritize Submission Prep", signalType: "deadline" }));
    if (summary.readinessScore < 50)
        signals.push(__assign(__assign({}, base), { riskColor: "amber", riskReason: "Readiness ".concat(summary.readinessScore, "% \u2014 below threshold"), nextAction: "Increase Workspace Readiness", signalType: "readiness" }));
    return signals;
}
function getAllTenderExecutionSignals() {
    return tenderWorkspaces.flatMap(function (ws) { return getTenderExecutionSignals(ws.tender.id); });
}
/**
...
function getTenderWorkspaceById(tenderId) {
    ...
    var tender = (0, tender_engine_1.getTenderById)(tenderId);
    if (!tender)
        return null;
    return {
        tender: tender,
        ...
        activityEvents: [
            {
                id: "act-fallback-".concat(tender.id),
                tenderWorkspaceId: tender.id,
                eventType: "workspace_created",
                description: "Tender workspace opened for ".concat(tender.title),
                userId: "u-system",
                userName: "System",
        ...
        auditEntries: [
            {
                id: "aud-fallback-".concat(tender.id),
                tenderWorkspaceId: tender.id,
                ...
                userName: "System",
                timestamp: tender.createdAt + "T00:00:00Z",
                details: "Tender workspace created. Customer: ".concat(tender.customerName, "."),
            },
        ],
    };
}
...
function getPackTypeLabel(type) {
    ...
    return (_a = labels[type]) !== null && _a !== void 0 ? _a : type;
}
...
function getSectionApprovalLabel(state) {
    ...
    return (_a = labels[state]) !== null && _a !== void 0 ? _a : state;
}
